<x-layout>
    ...
    {{-- <article class="py-8 mx-w-screen-md">
        ...
        <div>
            By
            <a href="/authors/{{ $post->author->username }}" class="text-base text-gray-500 hover:underline">{{ $post->author->name }} in</a> 
    ...
    <main class="pt-8 pb-16 lg:pt-2 lg:pb-24  dark:bg-gray-900 antialiased">
